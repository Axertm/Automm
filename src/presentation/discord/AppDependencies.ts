...
import type { AdminRetryPayoutUseCase } from '../../application/use-cases/admin/AdminRetryPayoutUseCase.js';
...
import type { IBackupAccountRepository } from '../../domain/repositories/IBackupAccountRepository.js';
...
export interface AppDependencies {
  ...
  backupAccountRepository: IBackupAccountRepository;
  dealBackupRepository: IDealBackupRepository;
  savedPayoutAddressRepository: ISavedPayoutAddressRepository;
  ...
  adminRetryPayout: AdminRetryPayoutUseCase;
