...
import { addDealBackupCommand } from './commands/admin/add-deal-backup.command.js';
import { removeDealBackupCommand } from './commands/admin/remove-deal-backup.command.js';
import { backupAccountCommand } from './commands/backup-account.command.js';
...
export function buildHandlerRegistry(): HandlerRegistry {
  ...
  for (const command of [
    ...
    dealInfoCommand,
    transcriptCommand,
    addDealBackupCommand,
    removeDealBackupCommand,
    backupAccountCommand,
    setPayoutAddressCommand,
    featuresCommand,
  ]) {
