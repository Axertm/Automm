...
export interface IBlockchainService {
  ...
  /**
   * Decrypts the wallet's key transiently inside this call only — never
   * returns key material to the caller. Broadcasts a single transaction
   * with all requested outputs where the chain supports multi-output.
   */
  sendPayout(params: {
