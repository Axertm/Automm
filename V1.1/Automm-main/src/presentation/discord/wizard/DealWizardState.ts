...
export interface DealWizardState {
  ...
  /** The other Discord user involved in the deal, picked by the initiator — not yet assigned a role. */
  participantId: string | null;
  participantConfirmed: boolean;

  /** Set once the initiator or participant claims that role for themselves; null until claimed. */
  buyerId: string | null;
