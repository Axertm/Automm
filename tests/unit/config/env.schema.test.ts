...
describe('envSchema', () => {
  ...
  it('applies documented defaults', () => {
    ...
    expect(result.USDT_REQUIRED_CONFIRMATIONS).toBe(30);
    expect(result.USDT_CONTRACT_ADDRESS).toBe('0xc2132D05D31c914a87C6611C10748AEb04B58e8F');
  });
